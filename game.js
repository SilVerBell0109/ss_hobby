(function () {
  var rounds = [
    ...
    { emoji: "✏️ 📔 🌈", answer: "그림 일기 쓰기", choices: ["다이어리 꾸미기", "공부 노트 정리", "그림 일기 쓰기", "인스타 피드 만들기"] },
    { emoji: "🎵 🎧 🌙", answer: "플레이리스트 만들기", choices: ["음악 감상회 가기", "플레이리스트 만들기", "악기 배우기", "노래방 가기"] },
    { emoji: "👟 🌳 ☁️", answer: "동네 산책", choices: ["등산하기", "자전거 타기", "동네 산책", "마라톤 준비"] },
    { emoji: "🌿 💧 ☀️", answer: "식물 키우기", choices: ["정원 가꾸기", "아쿠아리움 꾸미기", "식물 키우기", "테라리움 만들기"] },
    { emoji: "📸 🚶 🌆", answer: "사진 산책", choices: ["여행 사진 정리", "사진 산책", "SNS 피드 꾸미기", "사진 학원 등록"] }
  ];
